...
public class OfferViewCounterTest {
    ...
    public void testHandlerWithURLItShouldIgnore() {
        ...
        assertEquals("viewed 0 times", this.interceptor.getForUrl("/users/register"));
    }
    ...
    public void testHandlerWithBuyURL() {
        ...
        assertEquals("viewed 2 times", this.interceptor.getForUrl(ITEM_ONE_URL));
        assertEquals("viewed 3 times", this.interceptor.getForUrl(ITEM_TWO_URL));
    }
    ...
    public void testDeleteEntry() {
        ...
        assertEquals("viewed 0 times", this.interceptor.getForUrl(ITEM_ONE_URL));
    }
}